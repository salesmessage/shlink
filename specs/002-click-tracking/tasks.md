...
- [x] T028 Add the Kafka client and publisher to the divergence inventory in `.ai/rules/backend/fork-maintenance.md` with the JIRA key, in the same PR (infra)
